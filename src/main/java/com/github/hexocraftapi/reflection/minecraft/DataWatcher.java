...
import com.github.hexocraftapi.reflection.resolver.*;
		...
		public enum ValueType {
			...
			ValueType(String className, int index, int offset) {
				...
				try {
					...
					if (Minecraft.VERSION.newerThan(Minecraft.Version.v1_9_R1)) {
						System.err.println("[Reflection] Failed to find DataWatcherObject for " + className + " #" + index + " (" + firstObject + "+" + offset + ")");
					}
				}
			}
